          ...
          <div className={`p-8 rounded-3xl space-y-6 flex flex-col justify-between border transition-all duration-300 ${
            ...
            <div className="space-y-4">
              ...
              <ul className={`space-y-3.5 text-xs border-t pt-4 ${
                ...
                <li className="flex items-center gap-2"><Check size={14} className={`${theme === 'dark' ? 'text-amber-400' : 'text-amber-600'} shrink-0 font-bold`} /> <span className="font-semibold text-[11px] md:text-xs">Radar de Concorrentes (Inteligência de Mercado)</span></li>
